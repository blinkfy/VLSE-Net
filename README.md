...
## Model Architecture
The overall architecture of Vision-Language guided structure-enhanced Model (VLSE-Net) consists of two core modules: **LSCM** (semantic calibration) and **ASRM** (anisotropic structural refinement).
